...
export const fraudData: FraudTransaction[] = [
  ...
  // --- MONEY LAUNDERING (CIRCULAR P2P RING) ---
  {
    transaction_id: "ML_TXN_1",
    user_id: "L_USER_A",
    merchant_id: "L_USER_B",
    amount: 5000,
    transaction_velocity: 1,
    device_change_flag: 0,
    time_of_day: 10,
  ...
  {
    transaction_id: "ML_TXN_2",
    user_id: "L_USER_B",
    merchant_id: "L_USER_C",
    amount: 4950,
    transaction_velocity: 1,
    device_change_flag: 0,
    time_of_day: 11,
  ...
  {
    transaction_id: "ML_TXN_3",
    user_id: "L_USER_C",
    merchant_id: "L_USER_D",
    amount: 4900,
    transaction_velocity: 1,
    device_change_flag: 0,
    time_of_day: 12,
  ...
  {
    transaction_id: "ML_TXN_4",
    user_id: "L_USER_D",
    merchant_id: "L_USER_E",
    amount: 4850,
    transaction_velocity: 1,
    device_change_flag: 0,
    time_of_day: 13,
  ...
  {
    transaction_id: "ML_TXN_5",
    user_id: "L_USER_E",
    merchant_id: "L_USER_A",
    amount: 4800,
    transaction_velocity: 1,
    device_change_flag: 0,
    time_of_day: 14,
